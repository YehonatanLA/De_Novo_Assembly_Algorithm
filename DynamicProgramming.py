...
def find_filtered_root(vertex_to_index, edge_list):
    ...
    :param edge_list: A list of edges, where an edge in edge_list[i] means that the edge is from vertex in index i in vertices_list
    :return: None
    """
    root = None
...
def create_guesses(final_directed: FinalDirectedGraph, original_str_len):
    ...
    """
    if final_directed.num_of_vertices == 0:
        return None
